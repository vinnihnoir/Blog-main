            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <?php foreach($result as $entidade): 
                    ...
                    <tr>
                        ...
                        <td><?php echo $data; ?></td>
                        <td>
                            <a href="core/usuario_repositorio.php?acao=status&id=<?php echo $entidade['id']; ?>&valor=<?php echo $entidade['ativo'] == 1? 0 : 1; ?>" class="badge badge-<?php echo $entidade['ativo'] == 1 ? 'success' : 'danger'; ?>">
                                <?php echo $entidade['ativo'] == 1 ? 'Desativar' : 'Ativar'; ?>
                            </a>
                        </td>
                        <td>
                            <a href="core/usuario_repositorio.php?acao=adm&id=<?php echo $entidade['id']; ?>&valor=<?php echo $entidade['adm']== 1 ? 0 : 1; ?>" class="badge badge-<?php echo $entidade['adm'] == 1 ? 'primary' : 'secondary'; ?>">
